     ...
     F   G</pre>
      ...
      },
      {
        ...
        content: `<p>LR 的镜像：在 A 的<b>右孩子的左子树</b>插入。先以 <b>D</b> 为轴把 C 右旋拉直，再以 <b>D</b> 为轴把 A 左旋：</p>
          <pre class="lesson-tree">  A(2)             对C右旋        D(0)
 /    \\            ────→        /     \\
B      C(-1)      再对A左旋    A        C
      /    \\                  / \\     / \\
     D(插入) E                B   F   G   E
    / \\
   F   G</pre>
          <p>D 上升为新根：A 仍作 D 的左孩子（D 原左子树 F 归 A 当右孩子），G 归 C 当左孩子。新根 D 的 bf = 0。</p>
      ...
      },
      {
        ...
        content: `<p>依次插入 <b>{16, 3, 7, 11, 9, 26, 18, 14, 15}</b>，调整过程：</p>
          <table>
            ...
            <tr><td>18</td><td>bf(16)=2，右孩子 26 的 bf=−1 → <b>RL 双旋</b> → 18(16,26)</td></tr>
            <tr><td>14</td><td>无需旋转</td></tr>
            <tr><td>15</td><td>bf(16)=−2，左孩子 14 的 bf=1 → <b>LR 双旋</b> → 15(14,16)</td></tr>
          </table>
          <p>最终 AVL 树：<b>11( 7(3, 9), 18( 15(14, 16), 26 ) )</b>，所有结点 bf ∈ {−1, 0, 1} ✓（与课件一致）。</p>`,
      },
      {
        title: '复杂度与小结',
